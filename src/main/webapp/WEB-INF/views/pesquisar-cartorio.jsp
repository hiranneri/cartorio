		...
		<div class="c8">
			...
			<ul id="responsivemenu">
				...
				<ul style="display: none;">					
					...
					<li><a href="/desafiocartorios/cartorio/pesquisar">Cadastrar Cartório</a></li>
			...
			<div class="row">
				<div class="col-xs-12">
					...
					<form action="/desafiocartorios/cartorio/pesquisar" method="get" id="form_pesquisaCartorio" name="form_pesquisaCartorio">
						...
						<input type="radio" id="id" name="paramPesquisa" value="ID" onclick="exibeOutros();">
						<label for="id" onclick="exibeOutros();" id="id">ID</label>
						
						<input type="radio" id="nome" name="paramPesquisa" value="Nome" onclick="exibeOutros();">
						<label for="nome" onclick="exibeOutros();" id="nome">Nome<br></label><br>
					 	
					 	<input type="radio" id="cartorios" name="paramPesquisa" value="Cartórios" onclick="campoCartorio();">
						<label for="cartorios" onclick="campoCartorio();" id="cartorios">Cartórios<br></label><br>
					 	
			            
					 	 <input type="search" name="valor" id="valor" placeholder="Busca..." >
    	...
    	<thead>
    		...
    		<c:forEach var="cartorio" items="${listaCartorios}" >
				<tr>
		    		...
		    		<td>
			    		<a href="<c:url value="/desafiocartorios/cartorio/editar/"/>?id=${cartorio.id}">
			    			<button type="button" class="btn btn-success" value="Editar">Editar</button>
			    		</a>
		    		</td>
		    		<td>
		    			<a href="<c:url value="/desafiocartorios/cartorio/excluir/"/>?id=${cartorio.id}">
